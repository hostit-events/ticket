...
contract FactoryFacet {
    ...
    function ticketCount() public view returns (uint40) {
        return LibFactory._getTicketCount();
    }

    function ticketExists(uint40 _ticketId) public view returns (bool) {
        return _ticketId._ticketExists();
    }

    function ticketData(uint40 _ticketId) public view returns (FullTicketData memory) {
    ...
    function adminTickets(address _ticketAdmin) public view returns (uint40[] memory) {
    ...
    function ticketHash(uint40 _ticketId) public pure returns (bytes32) {
        return _ticketId._generateTicketHash();
    }

    function mainAdminRole(uint40 _ticketId) public pure returns (uint256) {
        return _ticketId._generateMainTicketAdminRole();
    }

    function ticketAdminRole(uint40 _ticketId) public pure returns (uint256) {
